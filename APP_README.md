...
- **New mocktail:** copy an existing line in `"mocktails"`, change the name `n`, price `p`, subtitle `sub`,
  description `d`, tags `t`, and base64 image `img`.
...
| **Pub-Style Realistic Scorekeepers** | Pool scorekeeper set inside a deep green felt bed with 3D pool balls; Darts scorekeeper styled as a pub slate chalkboard with Winmau wire dartboard. |
...
| **Artisanal Zero-Proof Mocktail Suite** | Dedicated luxury Emerald & Gold mocktail menu section featuring Cookie Butter Shots ($4), Pumpkin Coffee Brew ($7), Maple Caramel Apple Splash ($9.25), Kiwi Mint Lemonade ($9.50), and Cotton Candy Dream ($9.75), with embedded glassware photography, category filter chips, favorites saving, and community welcoming experience banner. |
